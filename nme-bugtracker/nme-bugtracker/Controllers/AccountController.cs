...
namespace nme_bugtracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> DemoLogin(string role)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(eMail, "Abcd&1234", false, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var email = new MailMessage(ConfigurationManager.AppSettings["emailfromto"], model.Email )
                {
                    Subject = "BugTracker Forgot Password - Reset Password",
